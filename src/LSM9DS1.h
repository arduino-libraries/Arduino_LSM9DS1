...
class LSM9DS1Class {
  public:
    ...
    virtual int   setAccelODR(uint8_t range); // Sample Rate 0:off, 1:10Hz, 2:50Hz, 3:119Hz, 4:238Hz, 5:476Hz, 6:952Hz, 7:NA Automatic setting of BW
    ...
    virtual int   setAccelFS(uint8_t range); // 0: ±2g ; 1: ±16g ; 2: ±4g ; 3: ±8g
    ...
    virtual int   setGyroODR(uint8_t range); //Sampling Rate 0:off, 1:10Hz, 2:50Hz, 3:119Hz, 4:238Hz, 5:476Hz, 6:952Hz, 7:NA
    ...
    virtual int   setMagnetODR(uint8_t range); // Sampling rate (0..7) corresponds to {0.625,1.25,2.5,5.0,10.0,20.0,40.0,80.0}Hz
